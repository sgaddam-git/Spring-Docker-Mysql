...
This Repo has creating containers for mysql
and running the liquibase scripts to create the schema and tables
and running the spring boot application with the local profile
